        ...
        {cards.length === 0 ? (
          <div
            style={{
              ...
              boxShadow: "0 2px 12px rgba(0,77,94,.03)",
            }}
          >
            <span className="material-symbols-rounded" style={{ fontSize: 36, color: "var(--ink4)", marginBottom: 10, display: "block" }}>
              travel_explore
            </span>
